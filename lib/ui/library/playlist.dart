...
class _PlaylistState extends State<Playlist> with WidgetsBindingObserver {
  ...
  final _playlist = ConcatenatingAudioSource(children: [
    AudioSource.uri(
      Uri.parse(
          "https://mopod-2.s3.us-east-2.amazonaws.com/(Off+the+Kush)+New+Pussy+.mp3"),
      tag: MediaItem(
        id: '${_nextMediaId++}',
        album: "Chris Kusher - Off The Kush",
        title: "New Pussy",
        artUri: Uri.parse(
    ...
    AudioSource.uri(
      Uri.parse(
          "https://mopod-2.s3.us-east-2.amazonaws.com/Gas+Up+master.mp3"),
      tag: MediaItem(
        id: '${_nextMediaId++}',
        album: "Slick Ivy & Chris Kusher - Gas Up",
        title: "Gas Up",
        artUri: Uri.parse(
            "https://mopod-2.s3.us-east-2.amazonaws.com/413OXatc0UL._UXNaN_FMjpg_QL85_.jpg"),
      ),
    ...
    AudioSource.uri(
      Uri.parse("https://mopod-2.s3.us-east-2.amazonaws.com/All+Nite.mp3"),
      tag: MediaItem(
        id: '${_nextMediaId++}',
        album: "Slick Ivy - All Nite",
        title: "Slick Ivy",
        artUri: Uri.parse(
            "https://mopod-2.s3.us-east-2.amazonaws.com/413OXatc0UL._UXNaN_FMjpg_QL85_.jpg"),
      ),
    ...
    AudioSource.uri(
      Uri.parse("https://mopod-2.s3.us-east-2.amazonaws.com/Jealousy+and+Envy.mp3"),
      tag: MediaItem(
        id: '${_nextMediaId++}',
        album: "MoWetTheDon - Jealousy & Envy",
        title: "Jealousy & Envy",
        artUri: Uri.parse(
            "https://mopod-2.s3.us-east-2.amazonaws.com/413OXatc0UL._UXNaN_FMjpg_QL85_.jpg"),
      ),
